...
void loop() {
  delay(16); // deve essere 1000 per release, 16 test
...
void confronti_sw2(int lettura) {
  if (lettura > pos5) {
    tempo = 5;   // 12;
    divisor = 2; // divisore 2 volte al giorno
    cr2 = 5;
    // esce dalla funzione confronti
    return;
  }
  ...
  if (lettura > pos4) {
    tempo = 5; // 8;
    divisor = 3; // divisore 3 volte al giorno
    cr2 = 4;
    // esce dalla funzione confronti
    return;
  }
  ...
  if (lettura > pos3) {
    tempo = 3; // 6;
    divisor = 4; // divisore 4 volte al giorno
    cr2 = 3;
    // esce dalla funzione confronti
    return;
  }
  ...
  if (lettura > pos2) {
    tempo = 2; // 4;
    divisor = 6; // divisore 6 volte al giorno
    cr2 = 2;
    // esce dalla funzione confronti
    return;
  }
  ...
  if (lettura > pos1) {
    ...
    divisor = 8; // divisore 8 volte al giorno
    cr2 = 1;
    // esce dalla funzione confronti
    return;
  }
